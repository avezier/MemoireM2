...
\end{prop}
\begin{proof}
Supposons par l'absurde qu'il existe une composante irréductible $Y$ de $X_{\text{sing}}$ de codimension $1$ dans $X$. Soit $U=\spec A$ un ouvert affine qui intersecte $Y$, et $\mathfrak{p}\in U$ le point générique de $Y$. L'idéal premier $\mathfrak{p}$ est de hauteur $1$, et comme $A$ est normal et noetherien, $A_\mathfrak{p}$ est un anneau de valuation discrète, donc $\mathfrak{p}$ est un point régulier, c'est une contradiction.
\end{proof}
