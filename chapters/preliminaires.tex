...
Soit $A$ un anneau intègre, et $\mathfrak{p}$ un idéal premier de hauteur $1$ tel que Soit $A_\mathfrak{p}$ soit un anneau de valuation discrète, on note $\mathfrak{m}:=\mathfrak{p}A_\mathfrak{p}$ son idéal maximal. Tout idéal fractionnaire non-nul de $A_\mathfrak{p}$ est inversible. Cette condition est même suffisante pour que $A_\mathfrak{p}$ soit un anneau de valuation discrète (voir \cite{atiyahmacdo} 9.7). Pour tout
