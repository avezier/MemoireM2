...
Soit $A$ une $R$-algèbre $\ZZ$-graduée et $M$ un $A$-module $\ZZ$-gradué. pour tout $n\in \ZZ$, on définit le $A$-module $M(d)$ tel que $M(n)_d=M_{n+d}$, pour tout $d\in \ZZ$.
\end{ex}
