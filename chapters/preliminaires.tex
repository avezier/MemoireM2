...
On fixe dans cette partie un $A$-module non-nul $M$ de type fini avec $A$ noetherien. On pense par exemple à $A/\mathfrak{a}$, où $\mathfrak{a}$ est un idéal de $A$. Voir \cite{Matsumura} Chap. 6 pour les preuves et plus de résultats.
