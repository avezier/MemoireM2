...
Un morphisme de schémas $f:X\rightarrow Y$ est fini si pour tout ouvert affine $V$ de $Y$, la $\Oo_Y(V)$-algèbre $(\Oo_X(f^{-1}(V)), f^\sharp(V))$ est finie.
\end{defn}
...
\end{prop}
\begin{proof}
Voir \cite[\href{http://stacks.math.columbia.edu/tag/01KP}{Lemma 01KP}]{stacks-project}
\end{proof}
...
\end{prop}
\begin{proof}
Voir \cite[ex III.10.4]{Hartshorne}
\end{proof}
