...
\begin{prop}\label{GITEtaleFiniteGroup}
Soit $X$ une $G$-variété avec $G$ fini agissant librement et telles que les orbites admettent des voisinages ouverts affines. Alors $(X,\pi)$ est un revêtement étale du quotient géométrique $X/G$.
\end{prop}
\begin{proof}
